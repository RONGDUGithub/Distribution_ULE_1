...
def discretize_interval_pm(C, d_pm):
    ...
    midpoints_minus1_to_1 = midpoints[h:h + d_pm]
...
def discretize_interval_sw(b, d_sw):
    ...
    # Initialize boundary matrix BM and midpoints array
    db_sw = 2 * h + d_sw  # Total number of segments
    BM = np.zeros((db_sw, 2))
